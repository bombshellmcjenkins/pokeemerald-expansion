...
const u32 gSummaryMoveBorder_Gfx[] = INCBIN_U32("graphics/summary_screen/move_border.4bpp.lz");
const u32 gSummaryMoveBorder_Pal[] = INCBIN_U32("graphics/summary_screen/move_border.gbapal.lz");
