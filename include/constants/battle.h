...
#define SIDE_STATUS_SHOCK_TRAP				(1 << 15) 
...
//#define SIDE_STATUS_SHOCK_TRAP				(1 << 27)

#define SIDE_STATUS_HAZARDS_ANY    (SIDE_STATUS_SPIKES | SIDE_STATUS_STICKY_WEB | SIDE_STATUS_TOXIC_SPIKES | SIDE_STATUS_STEALTH_ROCK | SIDE_STATUS_STEELSURGE | SIDE_STATUS_SHOCK_TRAP)
...
#define MOVE_EFFECT_EFFECT_SCALES		81
#define MOVE_EFFECT_HEAL_BELL			82
