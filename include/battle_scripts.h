...
extern const u8 BattleScript_EffectMemoryWipe[];
...
extern const u8 BattleScript_ShockTrapFree[];
...
extern const u8 BattleScript_ShockTrapDefog[];
...
extern const u8 BattleScript_EffectCompoundPoison[];
...
extern const u8 BattleScript_EffectShockTrap[];
...
extern const u8 BattleScript_EffectDissolve[];
...
extern const u8 BattleScript_EffectFurnace[];
extern const u8 BattleScript_EffectFruitSnack[];
extern const u8 BattleScript_EffectMoodSwing[];
extern const u8 BattleScript_MoodSwingAlly[];
extern const u8 BattleScript_MoodSwingEnemy[];
extern const u8 BattleScript_MoodSwingAllyAnim[];
extern const u8 BattleScript_MoodSwingTryRaiseSpeed[];
extern const u8 BattleScript_MoodSwingEnemyAnim[];
extern const u8 BattleScript_MoodSwingTryLowerSpDef[];
extern const u8 BattleScript_MoodSwingTryLowerSpeed[];
extern const u8 BattleScript_MoodSwingEnd[];
extern const u8 BattleScript_EffectForceOfWill[];
