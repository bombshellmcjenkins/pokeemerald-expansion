...
extern const u32 gSummaryMoveBorder_Gfx[];
extern const u32 gSummaryMoveBorder_Pal[];
...
extern const u32 gBattleAnimSpriteGfx_BirthrightSymbol[];
extern const u32 gBattleAnimSpritePal_BirthrightSymbol[];
